...
namespace Frontend.Logic.UnitTest
{
    ...
    public class FrontendUnitTest
    {
        ...
        [TestMethod]
        public void EditSize_IncorrectSize_ResponseCode500()
        {
            var client = new HttpClient();
            Frontend.AspMvc.Models.Size size = new AspMvc.Models.Size();

            var response = client.PostAsJsonAsync("http://127.0.0.1:9000/Size/updateBySize", size).Result;
        ...
        public void AddCategorie_IncorrectCategorie_ResponseCode500()
        {
            ...
            var response = client.PutAsJsonAsync("http://127.0.0.1:9000/Category/add", category).Result;


            Assert.AreEqual(HttpStatusCode.MethodNotAllowed, response.StatusCode);
        }
        [TestMethod]
        public void EditCategorie_IncorrectCategorie_ResponseCode500()
        {
            var client = new HttpClient();
            Frontend.AspMvc.Models.Category category = new AspMvc.Models.Category();
            category.Type = Type.Product;
        ...
        [TestMethod]
        public void EditMaterial_IncorectMaterial_ResponseCode500()
        {
            var client = new HttpClient();
            Frontend.AspMvc.Models.Material material = new AspMvc.Models.Material();
            material.MinValue = 5;
            material.Name = "Folie 139 14";
            material.Value = 5;
            var response = client.PutAsJsonAsync("http://127.0.0.1:9000/Article/updateByName", material).Result;
        ...
        [TestMethod]
        public void EditProduct_IncorectProduct_ResponseCode500()
        {
            var client = new HttpClient();
            Frontend.AspMvc.Models.Product product = new AspMvc.Models.Product();

            var response = client.PostAsJsonAsync("http://127.0.0.1:9000/Product/updateByName", product).Result;
